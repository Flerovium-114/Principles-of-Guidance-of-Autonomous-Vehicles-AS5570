...
theta3 = [-0.09, -0.3, -0.195, -0.193, -0.07, -0.04];
...
plot(x_T_results{1}(1), y_T_results{1}(1), 'bo', 'MarkerSize', 8, 'MarkerFaceColor', 'b'); % Target's initial position
plot(x_T_results{1}(end), y_T_results{1}(end), 'b*', 'MarkerSize', 8);                    % Target's final position

% Plot pursuer's initial and final positions
plot(x_P_results{1}(1), y_P_results{1}(1), 'ro', 'MarkerSize', 8, 'MarkerFaceColor', 'r'); % Pursuer's initial position
plot(x_P_results{1}(end), y_P_results{1}(end), 'r*', 'MarkerSize', 8);                    % Pursuer's final position
