...
[t,y] = ode45(@(t,y) LOS(t, y, V_P, V_T, R_P0, theta_P0, R_T0, theta_T0, V_R_P0, V_theta_P_0, V_R_T0, V_theta_T_0, alpha_P0, alpha_T0, x_P0, y_P0, x_T0, y_T0), t_span, y0, options);
